# Generated by Django 2.2 on 2019-12-11 07:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новая'), ('approved', 'Подтвержена')], default='new', max_length=20, verbose_name='Статус')),
